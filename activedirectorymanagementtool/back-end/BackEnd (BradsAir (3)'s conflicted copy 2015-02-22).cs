    ...
    public static partial class BackEnd
    {
        ...
        public static string testAuth()
        {
            ...
            try
            {
                ...
                return "Successfully authenticated to the " + DomainName + " domain as " + User + "! isAuthenticated = " + isAuthenticated.ToString();
            }
            catch (DirectoryServicesCOMException e)
            {
                ...
                return "ERROR: " + e.Message.ToString() + " The username or password may be incorrect. DOMAIN = " + DomainName + " USERNAME = " + User + " PASSWORD = " + Pass;
            }
            catch (Exception e)
            {
                directoryEntry.Close();
                ...
                // Provide an error message
                return "ERROR: " + e.Message.ToString() + " The domain name may be incorrect. DOMAIN = " + DomainName + " USERNAME = " + User + " PASSWORD = " + Pass;
            }
        }

        public static string getDistinguishedDomainName()
        {
            DomainName 
            return "DC=" + System.DirectoryServices.ActiveDirectory.Domain.GetDomain(new DirectoryContext(DirectoryContextType.Domain, DomainName, User, Pass)).Name.Replace(".", ",DC=");
        }
        ...
        public static List<Tree> getADObjects(string distinguishedName = "")
        {
            ...
            string test = getDistinguishedDomainName();
